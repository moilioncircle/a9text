...
var AreaTableParser = function()
{
    ...
    function __parseMode__(dom,para) // escape case
    {
        ...
        while(todoStr != null)
        {
            ...
            var modePos2 = todoStr.search(__regexp__.mode_join);
            var modePos3 = todoStr.search(__regexp__.mode_link);
            ...
            else
            {
                ...
                else if(modeType == 2) //join
                {
                    var modeDom = dom.newChild(A9Dom.type.mode_join);
                    modeDom.setText(modeTxt.substr(2));
                }
                else // link
                {
                    ...
                    modeDom.setText(modeTxt);
                    modeDom.putInfo(A9Dom.type.mode_link$name,modeTxt.substring(0,lp));
    ...
    ///// helper
    function __jointxt__(text) //TODO
    {
        return text;
    }
